...
const FileUploadAndAnswer = () => {
  ...
  return (
    ...
    <div className="flex">
    <input placeholder="Ask Your Question" className="ps-5 outline-none" type="text"/>



<button className="flex items-center justify-center px-4 py-2 text-sm font-medium text-white bg-blue-500 border border-transparent rounded-md hover:bg-blue-600 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2">
Ask &nbsp;&nbsp; 
...
export default FileUploadAndAnswer;
